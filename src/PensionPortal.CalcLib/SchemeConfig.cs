...
/// <param name="IncreaseMethod">How pension increases are applied once in payment (Separate or Overall).</param>
...
public record SchemeConfig(
    ...
    PensionIncreaseMethod IncreaseMethod = PensionIncreaseMethod.Separate,
